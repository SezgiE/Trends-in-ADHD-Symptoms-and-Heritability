...
## Script 8 for sum score analysis
...
setwd("./sum_score_analyses/model_results_SA/corr")
...
trend_df <- data.frame(read_excel("openmx_parameters_corr_SA.xlsx"))
...
plot_path <- file.path(output_dir, "model_trend_plot_corr_SA.png")
